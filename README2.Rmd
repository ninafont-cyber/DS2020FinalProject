...
ggplot(renew_parts, aes(year, consumption, fill = type)) +
  ...
  theme_minimal()
```
#My findings: Biomass currently is a majority of the US renewable energy source which makes sense since most cars run off of ethanol gas. you can see solar starting to get popular in the year 1987 and wind getting popular in the mid 2000s. Hydro has been consistent but not growing or shrinking and after doing research this is because no major dams have been built in a while. Geothermal energy is minimal and making it the outlier here.
